...
var G__41825 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__41825;
continue;
} else {
return ch;
...
var vec__41826 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__41826,(0),null);
return (match === s);
});
...
var len__29455__auto___41831 = arguments.length;
var i__29456__auto___41832 = (0);
while(true){
if((i__29456__auto___41832 < len__29455__auto___41831)){
args__29462__auto__.push((arguments[i__29456__auto___41832]));

var G__41833 = (i__29456__auto___41832 + (1));
i__29456__auto___41832 = G__41833;
continue;
} else {
}
break;
...
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq41829){
var G__41830 = cljs.core.first.call(null,seq41829);
var seq41829__$1 = cljs.core.next.call(null,seq41829);
return cljs.tools.reader.impl.commons.read_comment.cljs$core$IFn$_invoke$arity$variadic(G__41830,seq41829__$1);
});

cljs.tools.reader.impl.commons.throwing_reader = (function cljs$tools$reader$impl$commons$throwing_reader(msg){
return (function() { 
var G__41834__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__41834 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__41835__i = 0, G__41835__a = new Array(arguments.length -  1);
while (G__41835__i < G__41835__a.length) {G__41835__a[G__41835__i] = arguments[G__41835__i + 1]; ++G__41835__i;}
  _ = new cljs.core.IndexedSeq(G__41835__a,0,null);
} 
return G__41834__delegate.call(this,rdr,_);};
G__41834.cljs$lang$maxFixedArity = 1;
G__41834.cljs$lang$applyTo = (function (arglist__41836){
var rdr = cljs.core.first(arglist__41836);
var _ = cljs.core.rest(arglist__41836);
return G__41834__delegate(rdr,_);
});
...
//# sourceMappingURL=commons.js.map?rel=1517200925530
