...
var base_style__$1 = (cljs.core.truth_((function (){var and__28274__auto__ = selected_QMARK_;
...
var base_style__$2 = (cljs.core.truth_((function (){var and__28274__auto__ = selected_QMARK_;
if(cljs.core.truth_(and__28274__auto__)){
...
re_com.selection_list.list_container = (function re_com$selection_list$list_container(p__47519){
...
var args = map__47520__$1;
var disabled_QMARK_ = cljs.core.get.call(null,map__47520__$1,new cljs.core.Keyword(null,"disabled?","disabled?",-1523234181));
var on_change = cljs.core.get.call(null,map__47520__$1,new cljs.core.Keyword(null,"on-change","on-change",-732046149));
var height = cljs.core.get.call(null,map__47520__$1,new cljs.core.Keyword(null,"height","height",1025178622));
var item_renderer = cljs.core.get.call(null,map__47520__$1,new cljs.core.Keyword(null,"item-renderer","item-renderer",-743065410));
var model = cljs.core.get.call(null,map__47520__$1,new cljs.core.Keyword(null,"model","model",331153215));
var label_fn = cljs.core.get.call(null,map__47520__$1,new cljs.core.Keyword(null,"label-fn","label-fn",-860923263));
var required_QMARK_ = cljs.core.get.call(null,map__47520__$1,new cljs.core.Keyword(null,"required?","required?",-872514462));
var as_exclusions_QMARK_ = cljs.core.get.call(null,map__47520__$1,new cljs.core.Keyword(null,"as-exclusions?","as-exclusions?",-55596285));
var max_height = cljs.core.get.call(null,map__47520__$1,new cljs.core.Keyword(null,"max-height","max-height",-612563804));
var hide_border_QMARK_ = cljs.core.get.call(null,map__47520__$1,new cljs.core.Keyword(null,"hide-border?","hide-border?",1792698922));
var width = cljs.core.get.call(null,map__47520__$1,new cljs.core.Keyword(null,"width","width",-384071477));
var choices = cljs.core.get.call(null,map__47520__$1,new cljs.core.Keyword(null,"choices","choices",1385611597));
var id_fn = cljs.core.get.call(null,map__47520__$1,new cljs.core.Keyword(null,"id-fn","id-fn",316222798));
var multi_select_QMARK_ = cljs.core.get.call(null,map__47520__$1,new cljs.core.Keyword(null,"multi-select?","multi-select?",973156151));
...
var items = cljs.core.map.call(null,(cljs.core.truth_(item_renderer)?((function (selected,map__47520,map__47520__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__47516_SHARP_){
return item_renderer.call(null,p1__47516_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__47520,map__47520__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
:(cljs.core.truth_(multi_select_QMARK_)?((function (selected,map__47520,map__47520__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__47517_SHARP_){
return re_com.selection_list.as_checked.call(null,p1__47517_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__47520,map__47520__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
:((function (selected,map__47520,map__47520__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_){
return (function (p1__47518_SHARP_){
return re_com.selection_list.as_radio.call(null,p1__47518_SHARP_,id_fn,selected,on_change,disabled_QMARK_,label_fn,required_QMARK_,as_exclusions_QMARK_);
});})(selected,map__47520,map__47520__$1,args,disabled_QMARK_,on_change,height,item_renderer,model,label_fn,required_QMARK_,as_exclusions_QMARK_,max_height,hide_border_QMARK_,width,choices,id_fn,multi_select_QMARK_))
)),choices);
...
var len__29455__auto___47529 = arguments.length;
var i__29456__auto___47530 = (0);
while(true){
if((i__29456__auto___47530 < len__29455__auto___47529)){
args__29462__auto__.push((arguments[i__29456__auto___47530]));

var G__47531 = (i__29456__auto___47530 + (1));
i__29456__auto___47530 = G__47531;
continue;
} else {
}
break;
...
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(argseq__29463__auto__);
});

re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic = (function (p__47523){
...
var args = map__47524__$1;
if(cljs.core.truth_(((!(goog.DEBUG))?true:re_com.validate.validate_args.call(null,re_com.validate.extract_arg_data.call(null,re_com.selection_list.selection_list_args_desc),args,"selection-list")))){
} else {
throw (new Error("Assert failed: (validate-args-macro selection-list-args-desc args \"selection-list\")"));
}

return ((function (map__47524,map__47524__$1,args){
return (function() { 
var G__47532__delegate = function (p__47526){
...
var G__47532 = function (var_args){
var p__47526 = null;
if (arguments.length > 0) {
var G__47533__i = 0, G__47533__a = new Array(arguments.length -  0);
while (G__47533__i < G__47533__a.length) {G__47533__a[G__47533__i] = arguments[G__47533__i + 0]; ++G__47533__i;}
  p__47526 = new cljs.core.IndexedSeq(G__47533__a,0,null);
} 
return G__47532__delegate.call(this,p__47526);};
G__47532.cljs$lang$maxFixedArity = 0;
G__47532.cljs$lang$applyTo = (function (arglist__47534){
var p__47526 = cljs.core.seq(arglist__47534);
return G__47532__delegate(p__47526);
});
G__47532.cljs$core$IFn$_invoke$arity$variadic = G__47532__delegate;
return G__47532;
})()
;
;})(map__47524,map__47524__$1,args))
});

re_com.selection_list.selection_list.cljs$lang$maxFixedArity = (0);

re_com.selection_list.selection_list.cljs$lang$applyTo = (function (seq47522){
return re_com.selection_list.selection_list.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq47522));
});


//# sourceMappingURL=selection_list.js.map?rel=1517200939055
