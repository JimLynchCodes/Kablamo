...
if(cljs.core.truth_(mranderson047.re_frame.v0v10v2.re_frame.trace.trace_enabled_QMARK_)){
return cljs.core.swap_BANG_.call(null,mranderson047.re_frame.v0v10v2.re_frame.trace.trace_cbs,cljs.core.assoc,key,f);
} else {
return mranderson047.re_frame.v0v10v2.re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),"Tracing is not enabled. Please set {\"re_frame.trace.trace_enabled_QMARK_\" true} in :closure-defines. See: https://github.com/Day8/re-frame-trace#installation.");
}
});
...
mranderson047.re_frame.v0v10v2.re_frame.trace.start_trace = (function mranderson047$re_frame$v0v10v2$re_frame$trace$start_trace(p__41133){
...
var operation = cljs.core.get.call(null,map__41134__$1,new cljs.core.Keyword(null,"operation","operation",-1267664310));
var op_type = cljs.core.get.call(null,map__41134__$1,new cljs.core.Keyword(null,"op-type","op-type",-1636141668));
var tags = cljs.core.get.call(null,map__41134__$1,new cljs.core.Keyword(null,"tags","tags",1771418977));
var child_of = cljs.core.get.call(null,map__41134__$1,new cljs.core.Keyword(null,"child-of","child-of",-903376662));
...
//# sourceMappingURL=trace.js.map?rel=1517200923915
