...
var vec__48010_48013 = clojure.data.diff.call(null,orig_db,new_db);
var only_before_48014 = cljs.core.nth.call(null,vec__48010_48013,(0),null);
var only_after_48015 = cljs.core.nth.call(null,vec__48010_48013,(1),null);
var db_changed_QMARK__48016 = (!((only_before_48014 == null))) || (!((only_after_48015 == null)));
if(db_changed_QMARK__48016){
re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"group","group",582596132),"db clojure.data/diff for:",event);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only before:",only_before_48014);

re_frame.loggers.console.call(null,new cljs.core.Keyword(null,"log","log",-1595516004),"only after :",only_after_48015);
...
var map__48017 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
var map__48017__$1 = ((((!((map__48017 == null)))?((((map__48017.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__48017.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__48017):map__48017);
var db = cljs.core.get.call(null,map__48017__$1,new cljs.core.Keyword(null,"db","db",993250759));
var event = cljs.core.get.call(null,map__48017__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var map__48019 = new cljs.core.Keyword(null,"coeffects","coeffects",497912985).cljs$core$IFn$_invoke$arity$1(context);
...
var coeffects = map__48019__$1;
var event = cljs.core.get.call(null,map__48019__$1,new cljs.core.Keyword(null,"event","event",301435442));
...
var len__29455__auto___48022 = arguments.length;
var i__29456__auto___48023 = (0);
while(true){
if((i__29456__auto___48023 < len__29455__auto___48022)){
args__29462__auto__.push((arguments[i__29456__auto___48023]));

var G__48024 = (i__29456__auto___48023 + (1));
i__29456__auto___48023 = G__48024;
continue;
} else {
}
break;
...
re_frame.std_interceptors.path.cljs$lang$applyTo = (function (seq48021){
return re_frame.std_interceptors.path.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq48021));
});
...
var args__29462__auto__ = [];
var len__29455__auto___48030 = arguments.length;
var i__29456__auto___48031 = (0);
while(true){
if((i__29456__auto___48031 < len__29455__auto___48030)){
args__29462__auto__.push((arguments[i__29456__auto___48031]));

var G__48032 = (i__29456__auto___48031 + (1));
i__29456__auto___48031 = G__48032;
continue;
} else {
}
break;
...
return (function (p1__48025_SHARP_){
return cljs.core.get_in.call(null,new_db,p1__48025_SHARP_);
});})(new_db,old_db))
,in_paths);
var old_ins = cljs.core.map.call(null,((function (new_db,old_db,new_ins){
return (function (p1__48026_SHARP_){
return cljs.core.get_in.call(null,old_db,p1__48026_SHARP_);
...
re_frame.std_interceptors.on_changes.cljs$lang$applyTo = (function (seq48027){
var G__48028 = cljs.core.first.call(null,seq48027);
var seq48027__$1 = cljs.core.next.call(null,seq48027);
var G__48029 = cljs.core.first.call(null,seq48027__$1);
var seq48027__$2 = cljs.core.next.call(null,seq48027__$1);
return re_frame.std_interceptors.on_changes.cljs$core$IFn$_invoke$arity$variadic(G__48028,G__48029,seq48027__$2);
});


//# sourceMappingURL=std_interceptors.js.map?rel=1517200941313
