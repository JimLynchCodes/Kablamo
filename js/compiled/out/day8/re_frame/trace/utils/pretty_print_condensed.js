...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.subs.call(null,string,(0),(function (){var G__42167 = per_side_budget;
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42165__$1)].join('')));
...
var G__42174 = clojure.string.replace.call(null,s,match,trunc_prefix);
var G__42175 = limit;
var G__42176 = match;
var G__42177 = trunc_prefix;
s = G__42174;
limit = G__42175;
match = G__42176;
trunc_prefix = G__42177;
continue;
}
}
break;
...
var prefix = (function (){var G__42178 = ((kw_QMARK_)?":":"");
if(cljs.core.truth_(the_ns)){
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__42178),"\u2026/"].join('');
} else {
return G__42178;
}
})();
...
var vec__42180 = day8.re_frame.trace.utils.pretty_print_condensed.edges.call(null,coll);
var left = cljs.core.nth.call(null,vec__42180,(0),null);
var right = cljs.core.nth.call(null,vec__42180,(1),null);
...
var or__28286__auto__ = (function (){var G__42187 = form.name;
if((G__42187 == null)){
return null;
} else {
return clojure.string.replace.call(null,G__42187,/(^.*\$)(.*)/,"$2");
}
})();
...
if(cljs.core.truth_((function (){var and__28274__auto__ = enter_pred.call(null,form);
...
//# sourceMappingURL=pretty_print_condensed.js.map?rel=1517200926879
