...
var o39246 = temp__4655__auto__;
var temp__4655__auto____$1 = (o39246["core"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o39247 = temp__4655__auto____$1;
return (o39247["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__39104__auto__ = f;
return (o__39104__auto__["toString"]).call(o__39104__auto__);
} else {
return "";
}
}catch (e39248){var _ = e39248;
return "";
}});
...
try{var o__39104__auto___39250 = t;
(o__39104__auto___39250["cljs$lang$ctorPrWriter"]).call(o__39104__auto___39250,t,writer);
}catch (e39249){var __39251 = e39249;
}
...
var char_code = (function (){var o__39104__auto__ = (new String(char$));
return (o__39104__auto__["charCodeAt"]).call(o__39104__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__39104__auto__ = String;
return (o__39104__auto__["fromCharCode"]).call(o__39104__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__39252 = num_code;
switch (G__39252) {
case (1):
return (185);
...
var o__39104__auto__ = String;
return (o__39104__auto__["fromCharCode"]).call(o__39104__auto__,superscript_code);
});
/**
...
}catch (e39254){var _e__39111__auto__ = e39254;
return false;
}})())){
...
var vec__39255 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__39255,(0),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var o39258 = temp__4655__auto__;
var temp__4655__auto____$1 = (o39258["dependencies_"]);
if(cljs.core.truth_(temp__4655__auto____$1)){
var o39259 = temp__4655__auto____$1;
return (o39259["nameToPath"]);
} else {
return null;
}
} else {
...
var len__29455__auto___39266 = arguments.length;
var i__29456__auto___39267 = (0);
while(true){
if((i__29456__auto___39267 < len__29455__auto___39266)){
args__29462__auto__.push((arguments[i__29456__auto___39267]));

var G__39268 = (i__29456__auto___39267 + (1));
i__29456__auto___39267 = G__39268;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__39262){
var vec__39263 = p__39262;
var ns_detector = cljs.core.nth.call(null,vec__39263,(0),null);
...
var G__39269 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__39270 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__39269;
remaining_tokens = G__39270;
continue;
}
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq39260){
var G__39261 = cljs.core.first.call(null,seq39260);
var seq39260__$1 = cljs.core.next.call(null,seq39260);
return devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(G__39261,seq39260__$1);
});
...
var vec__39274 = cljs.core.split_with.call(null,(function (p1__39273_SHARP_){
return cljs.core.not_EQ_.call(null,p1__39273_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__39274,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__39274,(1),null);
...
var vec__39277 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__39277,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__39277,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__39280 = cljs.core.rest.call(null,remaining_tokens);
var G__39281 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__39280;
name_tokens = G__39281;
continue;
} else {
...
var vec__39284 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__39284,(0),null);
var arity = cljs.core.nth.call(null,vec__39284,(1),null);
var vec__39287 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__39287,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__39287,(1),null);
var vec__39290 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__39290,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__39290,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__39290,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__39290,(3),null);
...
var vec__39296 = result;
var munged_ns = cljs.core.nth.call(null,vec__39296,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__39296,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__39296,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__39296,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__39296,(4),null);
var arity = cljs.core.nth.call(null,vec__39296,(5),null);
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__39300 = temp__4655__auto__;
var munged_name = cljs.core.nth.call(null,vec__39300,(0),null);
var args = cljs.core.nth.call(null,vec__39300,(1),null);
var vec__39303 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__39303,(0),null);
var name = cljs.core.nth.call(null,vec__39303,(1),null);
...
var G__39306 = (arity + (1));
var G__39307 = (function (){var temp__4655__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__4655__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__39308){
var vec__39309 = p__39308;
var arity = cljs.core.nth.call(null,vec__39309,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__39309,(1),null);
...
return cljs.core.get.call(null,arities,p1__39312_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return (function (p1__39313_SHARP_){
return cljs.core.drop.call(null,(2),p1__39313_SHARP_);
...
var args__29462__auto__ = [];
var len__29455__auto___39320 = arguments.length;
var i__29456__auto___39321 = (0);
while(true){
if((i__29456__auto___39321 < len__29455__auto___39320)){
args__29462__auto__.push((arguments[i__29456__auto___39321]));

var G__39322 = (i__29456__auto___39321 + (1));
i__29456__auto___39321 = G__39322;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__39316){
var vec__39317 = p__39316;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__39317,(0),null);
...
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq39314){
var G__39315 = cljs.core.first.call(null,seq39314);
var seq39314__$1 = cljs.core.next.call(null,seq39314);
return devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic(G__39315,seq39314__$1);
});
...
var G__39323 = arg;
var G__39323__$1 = (((G__39323 instanceof cljs.core.Keyword))?G__39323.fqn:null);
switch (G__39323__$1) {
...
var map__39325 = options;
var map__39325__$1 = ((((!((map__39325 == null)))?((((map__39325.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__39325.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__39325):map__39325);
var include_ns_QMARK_ = cljs.core.get.call(null,map__39325__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__39325__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__39325__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__39325__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__39326 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__39326,(0),null);
var fn_name = cljs.core.nth.call(null,vec__39326,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__39326,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__39326,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__39326,(4),null);
var arity = cljs.core.nth.call(null,vec__39326,(5),null);
...
var o__39104__auto__ = f;
return (o__39104__auto__["getBasis"]).call(o__39104__auto__);
});
/**
...
}catch (e39330){var _e__39111__auto__ = e39330;
...
var G__39331 = (obj[cljs.core.first.call(null,path)]);
var G__39332 = cljs.core.rest.call(null,path);
obj = G__39331;
path = G__39332;
continue;
} else {
...
return (function (accum,p__39333){
var vec__39334 = p__39333;
var bit = cljs.core.nth.call(null,vec__39334,(0),null);
var protocol = cljs.core.nth.call(null,vec__39334,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__39337){
var vec__39338 = p__39337;
var ns = cljs.core.nth.call(null,vec__39338,(0),null);
var name = cljs.core.nth.call(null,vec__39338,(1),null);
var selector = cljs.core.nth.call(null,vec__39338,(2),null);
...
return (function (p__39342){
var vec__39343 = p__39342;
var munged_name = cljs.core.nth.call(null,vec__39343,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__39343,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__39343,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__39341_SHARP_){
return (obj[cljs.core.first.call(null,p1__39341_SHARP_)]);
});})(name,sorted_matches,vec__39343,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1517200919205
