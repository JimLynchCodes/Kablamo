...
var G__38952 = o;
(G__38952[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__38953__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__38953 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__38954__i = 0, G__38954__a = new Array(arguments.length -  0);
while (G__38954__i < G__38954__a.length) {G__38954__a[G__38954__i] = arguments[G__38954__i + 0]; ++G__38954__i;}
  args = new cljs.core.IndexedSeq(G__38954__a,0,null);
} 
return G__38953__delegate.call(this,args);};
G__38953.cljs$lang$maxFixedArity = 0;
G__38953.cljs$lang$applyTo = (function (arglist__38955){
var args = cljs.core.seq(arglist__38955);
return G__38953__delegate(args);
});
...
var G__38958 = jsprops;
(G__38958["defaultValue"] = value);

(G__38958["onChange"] = ((function (G__38958,v,value,on_change){
return (function (p1__38957_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__38957_SHARP_);
});})(G__38958,v,value,on_change))
);
...
var vec__38961 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__38961,(0),null);
var id = cljs.core.nth.call(null,vec__38961,(1),null);
var class$ = cljs.core.nth.call(null,vec__38961,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___38965 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___38965 == null)){
} else {
var key_38966 = temp__4661__auto___38965;
(jsprops["key"] = key_38966);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__38967 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__38967["name"] = c);
...
var len__29455__auto___38972 = arguments.length;
var i__29456__auto___38973 = (0);
while(true){
if((i__29456__auto___38973 < len__29455__auto___38972)){
args__29462__auto__.push((arguments[i__29456__auto___38973]));

var G__38974 = (i__29456__auto___38973 + (1));
i__29456__auto___38973 = G__38974;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq38970){
var G__38971 = cljs.core.first.call(null,seq38970);
var seq38970__$1 = cljs.core.next.call(null,seq38970);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__38971,seq38970__$1);
});
...
break;
default:
var G__38977 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__38977;
continue;
...
var n__29231__auto___38979 = a.length;
var i_38980 = (0);
while(true){
if((i_38980 < n__29231__auto___38979)){
(a[i_38980] = reagent.impl.template.as_element.call(null,(a[i_38980])));

var G__38981 = (i_38980 + (1));
i_38980 = G__38981;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__29231__auto___38982 = a.length;
var i_38983 = (0);
while(true){
if((i_38983 < n__29231__auto___38982)){
var val_38984 = (a[i_38983]);
if((cljs.core.vector_QMARK_.call(null,val_38984)) && ((reagent.impl.template.key_from_vec.call(null,val_38984) == null))){
(o["no-key"] = true);
} else {
}

(a[i_38983] = reagent.impl.template.as_element.call(null,val_38984));

var G__38985 = (i_38983 + (1));
i_38983 = G__38985;
continue;
} else {
}
...
var ctx = ({});
var vec__38986 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__38986,(0),null);
var derefed = cljs.core.nth.call(null,vec__38986,(1),null);
...
var G__38989 = (cljs.core.count.call(null,argv) - first_child);
switch (G__38989) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__38989){
...
//# sourceMappingURL=template.js.map?rel=1517200918396
