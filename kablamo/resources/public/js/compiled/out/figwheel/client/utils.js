...
return (new CustomEvent(event_name,(function (){var obj35693 = {"detail":data};
return obj35693;
})()));
} else {
...
var f = (function (){var pred__35700 = cljs.core._EQ_;
var expr__35701 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__35700.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__35701))){
return ((function (pred__35700,expr__35701){
return (function (p1__35694_SHARP_){
return console.warn(p1__35694_SHARP_);
});
;})(pred__35700,expr__35701))
} else {
if(cljs.core.truth_(pred__35700.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__35701))){
return ((function (pred__35700,expr__35701){
return (function (p1__35695_SHARP_){
return console.debug(p1__35695_SHARP_);
});
;})(pred__35700,expr__35701))
} else {
if(cljs.core.truth_(pred__35700.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__35701))){
return ((function (pred__35700,expr__35701){
return (function (p1__35696_SHARP_){
return console.error(p1__35696_SHARP_);
});
;})(pred__35700,expr__35701))
} else {
return ((function (pred__35700,expr__35701){
return (function (p1__35697_SHARP_){
return console.log(p1__35697_SHARP_);
});
;})(pred__35700,expr__35701))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__35704){
...
var eval_fn = cljs.core.get.call(null,map__35705__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__35707_SHARP_);
});})(new_def))
);
...
var ky = cljs.core.nth.call(null,vec__35709,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1517200911578
