...
var G__41841 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__41841;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__41842 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__41842,ch);
...
if(("\\" === ch__$1)){
var ch_41843__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_41843__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_41843__$2);
} else {
}

var G__41844 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__41844;
continue;
}
}
...
var vec__41852 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41852,(0),null);
var start_column = cljs.core.nth.call(null,vec__41852,(1),null);
...
var G__41855 = cljs.core.conj_BANG_.call(null,a,form);
a = G__41855;
continue;
}
}
...
var _STAR_read_delim_STAR_41856 = cljs.tools.reader._STAR_read_delim_STAR_;
...
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR_41856;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__41857 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41857,(0),null);
var start_column = cljs.core.nth.call(null,vec__41857,(1),null);
...
var vec__41860 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41860,(0),null);
var end_column = cljs.core.nth.call(null,vec__41860,(1),null);
...
var vec__41863 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41863,(0),null);
var start_column = cljs.core.nth.call(null,vec__41863,(1),null);
...
var vec__41866 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41866,(0),null);
var end_column = cljs.core.nth.call(null,vec__41866,(1),null);
...
var vec__41869 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41869,(0),null);
var start_column = cljs.core.nth.call(null,vec__41869,(1),null);
...
var vec__41872 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41872,(0),null);
var end_column = cljs.core.nth.call(null,vec__41872,(1),null);
...
var sb = (function (){var G__41875 = (new goog.string.StringBuffer());
G__41875.append(initch);
...
var G__41877 = (function (){var G__41876 = sb;
G__41876.append(ch);

return G__41876;
})();
var G__41878 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__41877;
ch = G__41878;
continue;
}
...
switch (G__41881) {
case "\\":
var G__41885 = (function (){var G__41882 = sb;
G__41882.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__41882;
})();
var G__41886 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__41885;
ch = G__41886;
continue;
...
break;
default:
var G__41887 = (function (){var G__41883 = sb;
G__41883.append(ch);

return G__41883;
})();
var G__41888 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__41887;
ch = G__41888;
continue;
...
var vec__41889 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41889,(0),null);
var end_column = cljs.core.nth.call(null,vec__41889,(1),null);
...
var vec__41892 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__41892,(0),null);
var column = cljs.core.nth.call(null,vec__41892,(1),null);
...
var vec__41897 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__41897,(0),null);
var column = cljs.core.nth.call(null,vec__41897,(1),null);
...
var vec__41902 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__41902,(0),null);
var column = cljs.core.nth.call(null,vec__41902,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__41907 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__41907,(0),null);
var start_column = cljs.core.nth.call(null,vec__41907,(1),null);
...
var vec__41910 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__41910,(0),null);
var end_column = cljs.core.nth.call(null,vec__41910,(1),null);
...
var G__41913 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__41913,true,null,opts,pending_forms);
...
var _STAR_suppress_read_STAR_41914 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_41914;
}});
...
var G__41915 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__41915,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__41915,rdr,first_line);
...
var G__41919 = matched;
var G__41920 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__41919;
finished = G__41920;
continue;
} else {
...
var _STAR_suppress_read_STAR_41921 = cljs.tools.reader._STAR_suppress_read_STAR_;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR_41921;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env41922 = cljs.tools.reader.arg_env;
cljs.tools.reader.arg_env = cljs.core.sorted_map.call(null);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__41923 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__41923,"(");
...
var G__41924 = (i + (1));
var G__41925 = cljs.core.conj_BANG_.call(null,args,(function (){var or__28286__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__28286__auto__)){
return or__28286__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env41922;
}});
/**
...
var ch = temp__4655__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__41926 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__41926);
...
var G__41927 = cljs.core.next.call(null,s__$1);
var G__41928 = ret;
s__$1 = G__41927;
r = G__41928;
continue;
...
var G__41929 = cljs.core.next.call(null,s);
var G__41930 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__41929;
key_vals = G__41930;
continue;
} else {
...
var gensym_env41934 = cljs.tools.reader.gensym_env;
...
}finally {cljs.tools.reader.gensym_env = gensym_env41934;
}});
...
var temp__4655__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__41935 = token;
var G__41935__$1 = (((G__41935 == null))?null:cljs.core.subs.call(null,G__41935,(1)));
var G__41935__$2 = (((G__41935__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__41935__$1));
var G__41935__$3 = (((G__41935__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__41935__$2));
var G__41935__$4 = (((G__41935__$3 == null))?null:cljs.core.symbol.call(null,G__41935__$3));
if((G__41935__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__41935__$4);
}
})():(function (){var G__41936 = token;
var G__41936__$1 = (((G__41936 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__41936));
if((G__41936__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__41936__$1);
}
})()
));
if(cljs.core.truth_(temp__4655__auto__)){
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__41947,reader){
...
var opts = map__41948__$1;
var eof = cljs.core.get.call(null,map__41948__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1517200926014
