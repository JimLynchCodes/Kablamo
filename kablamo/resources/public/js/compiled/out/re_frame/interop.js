...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__39085 = cljs.core.instance_QMARK_;
var expr__39086 = reactive_val;
if(cljs.core.truth_(pred__39085.call(null,reagent.ratom.RAtom,expr__39086))){
return "ra";
} else {
if(cljs.core.truth_(pred__39085.call(null,reagent.ratom.RCursor,expr__39086))){
return "rc";
} else {
if(cljs.core.truth_(pred__39085.call(null,reagent.ratom.Reaction,expr__39086))){
return "rx";
} else {
if(cljs.core.truth_(pred__39085.call(null,reagent.ratom.Track,expr__39086))){
return "tr";
} else {
return "other";
}
...
//# sourceMappingURL=interop.js.map?rel=1517200918679
