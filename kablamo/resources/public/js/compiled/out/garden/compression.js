 ...
 */
garden.compression.token_fn = (function garden$compression$token_fn(p__43459){
var vec__43460 = p__43459;
var tag = cljs.core.nth.call(null,vec__43460,(0),null);
var re = cljs.core.nth.call(null,vec__43460,(1),null);
return ((function (vec__43460,tag,re){
return (function (s){
...
var len__29455__auto___43465 = arguments.length;
var i__29456__auto___43466 = (0);
while(true){
if((i__29456__auto___43466 < len__29455__auto___43465)){
args__29462__auto__.push((arguments[i__29456__auto___43466]));

var G__43467 = (i__29456__auto___43466 + (1));
i__29456__auto___43466 = G__43467;
continue;
} else {
}
break;
...
return garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(argseq__29463__auto__);
});
...
return (function (p1__43463_SHARP_){
return p1__43463_SHARP_.call(null,s);
});})(fs))
,fs);
});
;})(fs))
...
garden.compression.tokenizer.cljs$lang$applyTo = (function (seq43464){
return garden.compression.tokenizer.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq43464));
});
...
var map__43468 = temp__4655__auto__;
var map__43468__$1 = ((((!((map__43468 == null)))?((((map__43468.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__43468.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__43468):map__43468);
var tag = cljs.core.get.call(null,map__43468__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var chunk = cljs.core.get.call(null,map__43468__$1,new cljs.core.Keyword(null,"chunk","chunk",-1191159620));
var size = cljs.core.get.call(null,map__43468__$1,new cljs.core.Keyword(null,"size","size",1098693007));
var G__43471 = cljs.core.subs.call(null,s1,size);
var G__43472 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(s2),cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var G__43470 = tag;
var G__43470__$1 = (((G__43470 instanceof cljs.core.Keyword))?G__43470.fqn:null);
switch (G__43470__$1) {
case "string":
return chunk;
...
//# sourceMappingURL=compression.js.map?rel=1517200929582
